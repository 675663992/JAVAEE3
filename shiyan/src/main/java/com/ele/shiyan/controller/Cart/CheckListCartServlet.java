...
@WebServlet(name = "CheckListCartServlet", urlPatterns = {"/CartController/listCart"})
public class CheckListCartServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Cart> list = cartService.listCart(userId);
