...
@WebServlet(name = "CheckBusinessServlet", urlPatterns = {"/BusinessController/listBusinessByOrderTypeId"})
public class CheckBusinessServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Business> list = businessService.listBusinessByOrderTypeId(orderTypeId);
